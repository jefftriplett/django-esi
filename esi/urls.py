...
urlpatterns = [
    url(
        r'^(?P<app_label>[\w-]+)/(?P<model_name>[\w-]+)/(?P<object_id>\d+)/$',
        'esi.views.esi',
        name='esi'),
    url(
        r'^(?P<app_label>[\w-]+)/(?P<model_name>[\w-]+)/(?P<object_id>\d+)/(?P<timeout>\d+)/$',
        'esi.views.esi',
        name='esi'),
    url(
        r'^(?P<app_label>[\w-]+)/(?P<model_name>[\w-]+)/(?P<object_id>\d+)/(?P<timeout>\d+)/(?P<template>[\w\-\/\.]+)/$',
        'esi.views.esi',
        name='esi'),
